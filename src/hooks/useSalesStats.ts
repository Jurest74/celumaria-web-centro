...
export function useSalesStats({
  ...
  const fetchStatsInternal = async () => {
    ...
    try {
      ...
      switch (dateFilter) {
        case 'today':
          startISO = startOfDayBogota();
          endISO = endOfDayBogota();
          break;
        case 'week':
          startISO = startOfDayBogota(subtractDaysBogota(7));
          endISO = endOfDayBogota();
          break;
        case 'month':
          startISO = startOfDayBogota(subtractDaysBogota(30));
          endISO = endOfDayBogota();
          break;
        case '3months':
        ...
        case '6months':
          ...
          break;
        case 'year':
          startISO = startOfDayBogota(subtractDaysBogota(365));
          endISO = endOfDayBogota();
          break;
        case 'custom':
      ...
      // Refinamiento por hora del día (en hora Colombia)
