...
export const getColombiaTimestamp = (): string => {
  // Se guarda en UTC puro para que las queries de Firestore (comparación de strings)
  // funcionen correctamente. El display usa { timeZone: 'America/Bogota' } para
  // mostrar siempre la hora Colombia sin importar la zona del dispositivo.
